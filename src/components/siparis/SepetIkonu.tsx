...
/**
 * Ust bardaki sepet dugmesi ve urun sayisi rozeti.
 *
 * Sepet localStorage'dan geldigi icin sunucuda bilinmiyor. Rozet ancak
 * istemci baglandiktan sonra cizilir; aksi halde sunucu ciktisiyla
 * uyusmazlik (hydration) hatasi olusur.
 */
export default function SepetIkonu() {
  ...
  const adet = baglandi && tur === "paket" ? toplamAdet(kalemler) : 0;
