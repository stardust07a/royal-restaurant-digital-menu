...
const SOZLUK = {
  ...
  slugGelismis: ["Bağlantı ayarları (gelişmiş)", "إعدادات الرابط (متقدم)"],
  slugOtomatikIpucu: [
    "Yeni kayıtların bağlantı adı Türkçe addan otomatik oluşur. Mevcut bağlantıyı değiştirmek eski linkleri bozabilir.",
    "يُنشأ اسم الرابط تلقائياً من الاسم التركي عند الإضافة. تغيير رابط موجود قد يعطّل الروابط القديمة.",
  ],
  stokta: ["Stokta", "متوفر"],
  ...
  kategoriUrunleriIpucu: [
    "İşaretlenen ürün bu kategoriye de eklenir. Sıralamak için tutamacı sürükle; klavyede yukarı/aşağı oklarını kullan.",
    "يُضاف المنتج المحدد إلى هذا القسم أيضاً. اسحب المقبض للترتيب، أو استخدم سهمي الأعلى والأسفل بلوحة المفاتيح.",
  ],
  surukleSirala: ["Sürükleyerek sırala", "اسحب للترتيب"],
